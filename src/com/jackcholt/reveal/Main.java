...
public class Main extends ListActivity implements OnGestureListener {
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        SharedPreferences sharedPref = mSharedPref = PreferenceManager
        ...
        if (mUpdating) {
            ...
            Thread t = new Thread() {
                public void run() {
                    ...
                    refreshLibrary(mSharedPref.getString(
            ...
            for (int i = 0, dirListLen = ybkFiles.length; i < dirListLen; i++) {
                ...
                if (!fileFoundInDb) {
                    ...
                    try {
                        ...
                        YbkFileReader ybkRdr = new YbkFileReader(this,
                                dirFilename);
                        ...
                        // refreshBookList();
                        mBookTitleList = ybkDao.getBookTitles().getList(null,
                                null);
    ...
    private void refreshBookList() {
        ...
        // Now create a simple adapter and set it to display
        ArrayAdapter<Book> bookAdapter = new ArrayAdapter<Book>(this,
                R.layout.book_list_row, mBookTitleList);
